      ...
      <el-col :lg="8" :md="12" :sm="24" :xl="8" :xs="24">
        <el-form ref="registerForm" class="register-form" :model="form" :rules="registerRules" size="mini">
          <el-form-item prop="username">
            <el-input v-model.trim="form.username" v-focus auto-complete="off" placeholder="请输入用户名"
              style="margin-top: 20px" type="text">
              <vab-icon slot="prefix" :icon="['fas', 'user-alt']" />
            </el-input>
          </el-form-item>
          <el-form-item prop="phone">
            <el-input v-model.trim="form.phone" autocomplete="off" maxlength="11" placeholder="请输入手机号" show-word-limit
              type="text">
