...
process.env.VUE_APP_TITLE = title || '伟骅管理系统'
...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      '/api': {
        // target: 'http://192.168.10.237:9289', // 你的后端地址
        target: 'http://192.168.10.254:8081/mock/100065', //mock接口
        // changeOrigin: true,
        pathRewrite: {
          '^/api': '/api' // 把 /api 替换为空，转发到后端
        }
      },
      '/uploads': {
        target: 'http://192.168.10.237:9289',
        // changeOrigin: true,
        pathRewrite: {
          '^/uploads': '/uploads'
        }
